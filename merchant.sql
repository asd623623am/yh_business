...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES ('12', '1', 'admin', '8888@qq.com', '1bf61917d4b4ec70d667573b031e488e', 's=1+89', '1590547014', '11111111111', null, '');
...
-- ----------------------------
INSERT INTO `admin_role` VALUES ('1', '9', '1');
INSERT INTO `admin_role` VALUES ('2', '10', '1');
INSERT INTO `admin_role` VALUES ('3', '11', '1');
INSERT INTO `admin_role` VALUES ('4', '13', '6');
INSERT INTO `admin_role` VALUES ('5', '14', '2');
...
CREATE TABLE `applets` (
  ...
  `termNo` char(50) DEFAULT NULL COMMENT '设备号',
  `merId` char(50) DEFAULT NULL COMMENT '商户id',
  `appId` char(50) DEFAULT NULL,
  `secret` char(50) DEFAULT NULL,
  `pay_secret` char(50) DEFAULT NULL COMMENT '支付秘钥',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='微信小程序参数配置';

-- ----------------------------
-- Records of applets
-- ----------------------------
INSERT INTO `applets` VALUES ('1', 'HX10002688', '1344296701', 'wx0731f3694a3fb5ba', '77c21827d4725764696718349e5044d6', '延龙物业');
INSERT INTO `applets` VALUES ('2', 'HX10017042', '10013870', 'wxae931c3f94b5f99a', 'c213852f240f42cd9cb6bbdd986ae004', '北京金立恒达供暖');
...
-- Records of banner
-- ----------------------------
INSERT INTO `banner` VALUES ('10', '#20200622/7139c7c0cf57cf3399ff62c7ae208c55.png', '1', '1592809903');
INSERT INTO `banner` VALUES ('11', '#20200622/6e4fc586610a2ef042bd680f5f644032.png', '1', '1592809915');
INSERT INTO `banner` VALUES ('12', '#20200622/cc74be47691054bd67a9c3618fd7d847.png', '1', '1592809924');
...
CREATE TABLE `brand` (
  ...
  `brand_title` varchar(50) DEFAULT NULL COMMENT '标题',
  `brand_describe` text,
...
-- Records of brand
-- ----------------------------
INSERT INTO `brand` VALUES ('1', '20200724/c871055862557d15e4e335566b6d5658.jpg', '欢迎使用延龙物业小程序', '-物业缴费，-供暖缴费，-押金缴费。<br/>人在哪里都可以缴费！', '1', '1595560441');
...
CREATE TABLE `deposit` (
  ...
  `order_no` char(21) DEFAULT NULL COMMENT '订单号',
  `user_name` char(50) DEFAULT NULL COMMENT '户主名称',
  `home_id` int(11) DEFAULT NULL COMMENT '房屋ID',
  `home_name` varchar(255) DEFAULT NULL COMMENT '房间名称',
  `msg` varchar(255) DEFAULT NULL COMMENT '账单标题',
  `title` varchar(255) DEFAULT NULL COMMENT '备注',
  `deposit_status` char(1) DEFAULT NULL COMMENT '0是未缴费、1缴费、2退款',
  `deposit_money` decimal(18,2) DEFAULT NULL COMMENT '缴费金额',
  `refund_money` decimal(18,2) DEFAULT NULL COMMENT '退款金额',
  `cost_info` text COMMENT '费用明细',
  `deposit_url` char(1) DEFAULT NULL COMMENT '缴费渠道 1在线、2pos机、3现金',
  `transNo` varchar(100) DEFAULT NULL COMMENT '交易号',
  `payType` char(1) DEFAULT NULL COMMENT '1为微信 2为支付宝',
  `merchantId` int(11) DEFAULT NULL COMMENT '商户ID',
  `refundOrderNo` varchar(50) DEFAULT NULL COMMENT '退款订单号',
  `paytime` int(11) DEFAULT NULL COMMENT '支付时间',
  `status` char(1) DEFAULT NULL COMMENT '1正常、2删除',
  `ctime` int(11) DEFAULT NULL,
  PRIMARY KEY (`deposit_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='押金管理表';
...
CREATE TABLE `district` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='小区信息';

-- ----------------------------
-- Records of district
-- ----------------------------
INSERT INTO `district` VALUES ('1', '青年路', '1596803007', '1596803007');
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='反馈表';

-- ----------------------------
-- Records of feedback
-- ----------------------------
INSERT INTO `feedback` VALUES ('14', '反馈测试\n', null, 'o4C2C4t6unZm51TcEbH3go_MIWQc', '1', '1596102878');
...
CREATE TABLE `home` (
  ...
  `home_ids` varchar(30) DEFAULT NULL COMMENT '房屋ID 客户看的唯一标识',
  `district_id` int(11) DEFAULT NULL COMMENT '小区id',
  `district_name` varchar(30) DEFAULT NULL COMMENT '小区名称',
  `complex` varchar(30) DEFAULT NULL COMMENT '区',
  `home_code` varchar(30) DEFAULT NULL COMMENT '楼号',
  `building` varchar(30) DEFAULT NULL COMMENT '楼',
  `unit` varchar(30) DEFAULT NULL COMMENT '单元',
  `room` varchar(30) DEFAULT NULL COMMENT '房间号',
  `owner` varchar(30) DEFAULT NULL COMMENT '业主姓名',
  `tel` varchar(255) DEFAULT NULL COMMENT '联系方式 多个手机号用，区分',
  `area` decimal(10,2) DEFAULT NULL COMMENT '面积',
  `check_in_at` varchar(20) DEFAULT NULL COMMENT '入住时间',
  `is_delete` char(1) DEFAULT NULL COMMENT '1正常2删除',
  `content` text COMMENT '备注',
  `ctime` int(11) DEFAULT NULL COMMENT '添加时间',
  `utime` int(11) DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`home_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='房屋表';

-- ----------------------------
-- Records of home
-- ----------------------------
INSERT INTO `home` VALUES ('1', '20200807202353927476', '1', '青年路', '甲', '1-1-101', '1', '1', '101', '贾', '15100000000', '100.00', '2018-08-07', '1', '', '1596803033', null);
...
CREATE TABLE `house` (
  ...
  `utime` int(11) NOT NULL DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8 COMMENT='房屋信息';

-- ----------------------------
-- Records of house
-- ----------------------------
INSERT INTO `house` VALUES ('13', '5', '甲', '1', '5', '402', '业主1', '13412312312', '166.480', '1.310', '2.120', '1580486400', '0', '1590995177', '1590995177');
INSERT INTO `house` VALUES ('14', '1', '乙', '1', '3', '107', '业主2', '13412312313', '151.160', '1.410', '6.100', '1586016000', '0', '1590995177', '1590995177');
INSERT INTO `house` VALUES ('15', '1', '甲', '3', '2', '208', '业主3', '13412312314', '142.260', '3.140', '1.880', '1546790400', '0', '1590995177', '1590995177');
INSERT INTO `house` VALUES ('16', '1', '甲', '1', '5', '417', '业主4', '13412312312', '166.480', '1.310', '2.120', '1580486400', '0', '1590995194', '1590995194');
INSERT INTO `house` VALUES ('17', '1', '乙', '1', '3', '322', '业主5', '13412312313', '151.160', '1.410', '6.120', '1586016000', '0', '1590995194', '1590995194');
INSERT INTO `house` VALUES ('18', '5', '甲', '3', '2', '810', '业主6', '13412312314', '142.260', '3.140', '1.880', '1546790400', '0', '1590995194', '1590995194');
INSERT INTO `house` VALUES ('19', '1', '甲', '1', '5', '506', '业主7', '13412312312', '166.480', '1.310', '2.120', '1580486400', '0', '1590995224', '1590995224');
INSERT INTO `house` VALUES ('20', '1', '乙', '1', '3', '409', '业主8', '13412312313', '151.160', '1.410', '6.120', '1586016000', '0', '1590995224', '1590995224');
INSERT INTO `house` VALUES ('21', '1', '甲', '3', '2', '509', '业主9', '13412312314', '142.260', '3.140', '1.880', '1546790400', '0', '1590995224', '1590995224');
INSERT INTO `house` VALUES ('22', '5', '甲', '1', '5', '106', '业主10', '13412312312', '166.480', '1.310', '2.120', '1580486400', '0', '1590995856', '1590995856');
INSERT INTO `house` VALUES ('23', '1', '乙', '1', '3', '413', '业主11', '13412312313', '151.160', '1.410', '6.120', '1586016000', '0', '1590995856', '1590995856');
INSERT INTO `house` VALUES ('24', '5', '甲', '3', '2', '710', '业主12', '13412312314', '142.260', '3.140', '1.880', '1546790400', '0', '1590995856', '1590995856');
INSERT INTO `house` VALUES ('25', '1', '甲', '1', '5', '605', '业主13', '13412312312', '166.480', '1.310', '2.120', '1580486400', '0', '1591095184', '1591095184');
INSERT INTO `house` VALUES ('26', '1', '乙', '1', '3', '809', '业主14', '13412312313', '151.160', '1.410', '6.120', '1586016000', '0', '1591095184', '1591095184');
INSERT INTO `house` VALUES ('27', '1', '甲', '3', '2', '908', '业主15', '13412312314', '142.260', '3.140', '1.880', '1546790400', '0', '1591095184', '1591095184');
...
-- Records of images
-- ----------------------------
INSERT INTO `images` VALUES ('1', '#20200710/5f481b939f7e572691cb41e1f074821b.jpg');
INSERT INTO `images` VALUES ('2', '#20200710/1b7bb8028c14fdc5dd1e2d75852f41e8.jpg');
INSERT INTO `images` VALUES ('3', '#20200710/9f3630da882d1f518c665c7725aa6c25.png');
INSERT INTO `images` VALUES ('4', '#20200710/307979642a8d3c4046013e6156bf4c8b.png');
INSERT INTO `images` VALUES ('5', '#20200713/44d1bbfb0c21b61b77b5cac8e547a26d.png');
INSERT INTO `images` VALUES ('6', '#20200715/aa5ef7dbb8813fafe0cfe4aeb575068d.png');
...
-- Records of log
-- ----------------------------
INSERT INTO `log` VALUES ('1', 'admin', '添加了一个房屋', '1596803033');
...
-- ----------------------------
-- Table structure for order_no
-- ----------------------------
DROP TABLE IF EXISTS `order_no`;
CREATE TABLE `order_no` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `order_no` char(21) DEFAULT NULL COMMENT '订单号',
  `p_id` int(11) DEFAULT NULL COMMENT '物业、供暖id',
  `pay_status` char(1) DEFAULT NULL COMMENT '支付状态：0是未支付、1是已缴费、2是已退款',
  `invoice_status` char(1) DEFAULT NULL COMMENT '发票状态:1未开、2开了',
  `title` varchar(255) DEFAULT NULL COMMENT '标题',
  `type` char(1) DEFAULT NULL COMMENT '订单类型：0物业、1供暖、2押金',
  `pay_type` char(1) DEFAULT NULL COMMENT '支付方式：1在线支付、2pos机支付、3线下支付',
  `user_name` varchar(30) DEFAULT NULL COMMENT '户主名称',
  `district_id` int(11) DEFAULT NULL COMMENT '小区ID',
  `district_name` varchar(255) DEFAULT NULL COMMENT '小区名称',
  `complex` varchar(255) DEFAULT NULL COMMENT '区',
  `home_code` varchar(255) DEFAULT NULL COMMENT '楼号',
  `home_id` int(11) DEFAULT NULL COMMENT '房间ID',
  `home_name` varchar(255) NOT NULL COMMENT '房间名称',
  `msg` varchar(255) DEFAULT NULL COMMENT '账单标题',
  `paytime` int(11) DEFAULT NULL COMMENT '缴费年',
  `fee` decimal(10,2) DEFAULT NULL COMMENT '缴费金额',
  `pay_fee` decimal(10,2) DEFAULT NULL COMMENT '实付金额',
  `compensation` decimal(10,2) DEFAULT NULL COMMENT '赔偿项',
  `voucher` varchar(21) DEFAULT NULL COMMENT '凭证号',
  `start_at` int(11) DEFAULT NULL COMMENT '缴费开始时间',
  `end_at` int(11) DEFAULT NULL COMMENT '缴费结束时间',
  `finish_at` int(11) DEFAULT NULL COMMENT '缴费完成时间',
  `transNo` varchar(100) DEFAULT NULL COMMENT '交易号',
  `payTypes` char(1) DEFAULT NULL COMMENT 'pos机支付：1微信2支付宝',
  `merchantId` int(11) DEFAULT NULL COMMENT '商户id',
  `refund_money` decimal(10,2) DEFAULT NULL COMMENT '退款金额',
  `refundOrderNo` varchar(50) DEFAULT NULL COMMENT '退款订单号',
  `cost_info` text COMMENT '明细',
  `status` int(11) DEFAULT NULL COMMENT '1正常2删除',
  `ctime` int(11) DEFAULT NULL,
  `utime` int(11) DEFAULT NULL,
  `month` int(11) DEFAULT NULL COMMENT '月份，只有物业有，供暖押金都没有',
  `cost` decimal(10,2) DEFAULT NULL COMMENT '物业是费用，供暖是系数',
  `money` decimal(10,2) DEFAULT NULL COMMENT '缴费总金额',
  PRIMARY KEY (`id`,`home_name`)
...
CREATE TABLE `payment` (
  ...
  `type` int(11) DEFAULT NULL COMMENT '1是物业2是供暖',
  `complex` varchar(255) DEFAULT NULL COMMENT '区',
  `d_id` int(11) DEFAULT NULL COMMENT '小区ID',
  `d_name` varchar(255) DEFAULT NULL COMMENT '小区名称',
  `home_code` varchar(255) DEFAULT NULL COMMENT '楼号',
  `paytime` char(11) DEFAULT NULL COMMENT '缴费年',
  `fee` decimal(10,2) DEFAULT NULL COMMENT '每平米缴费金额',
  `compensation` decimal(10,2) DEFAULT NULL COMMENT '赔偿项',
  `voucher` int(11) DEFAULT NULL COMMENT '凭证号',
  `start_at` int(11) DEFAULT NULL COMMENT '开始缴费时间',
  `end_at` int(11) DEFAULT NULL COMMENT '结束缴费时间',
  `status` int(11) DEFAULT NULL COMMENT '1正常2删除',
  `ctime` int(11) DEFAULT NULL,
  `utime` int(11) DEFAULT NULL,
  `building` varchar(30) DEFAULT NULL COMMENT '楼',
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='物业电话';

-- ----------------------------
-- Records of phone
-- ----------------------------
INSERT INTO `phone` VALUES ('10', '报修1', '99999999', '1', '1594780863');
INSERT INTO `phone` VALUES ('11', '报修2', '889855', '1', '1594780888');
INSERT INTO `phone` VALUES ('12', '报修3', '77899555', '1', '1594780906');
INSERT INTO `phone` VALUES ('13', '收费室', '1234569', '1', '1594780922');

-- ----------------------------
-- Table structure for posconfg
-- ----------------------------
DROP TABLE IF EXISTS `posconfg`;
CREATE TABLE `posconfg` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `SN` varchar(50) DEFAULT NULL COMMENT '设备号',
  `merId` varchar(50) DEFAULT NULL COMMENT '商户号',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='pos机配置表';

-- ----------------------------
-- Records of posconfg
-- ----------------------------
INSERT INTO `posconfg` VALUES ('2', '1747CA836045', '1344296701');
INSERT INTO `posconfg` VALUES ('3', '4561', '123');
INSERT INTO `posconfg` VALUES ('4', '', '');
...
INSERT INTO `power_node` VALUES ('5', '通知公告', '/Brand/brandList', '2', '4', '1', null, null);
INSERT INTO `power_node` VALUES ('6', '内容添加', '/Brand/brandAdd', '2', '4', '2', null, null);
...
INSERT INTO `power_node` VALUES ('10', '权限节点管理', '/Power', '1', '0', '2', '1540869853', null);
INSERT INTO `power_node` VALUES ('11', '权限节点添加', '/Power/powerAdd', '2', '10', '2', '1540870190', null);
INSERT INTO `power_node` VALUES ('12', '权限节点列表', '/Power/powerList', '2', '10', '2', '1540870204', null);
INSERT INTO `power_node` VALUES ('13', '角色管理', '/Role', '1', '0', '2', '1541638484', null);
INSERT INTO `power_node` VALUES ('14', '角色添加', '/Role/roleAdd', '2', '57', '2', '1541638508', null);
INSERT INTO `power_node` VALUES ('15', '角色列表', '/Operation/roleList', '2', '57', '1', '1541638523', null);
INSERT INTO `power_node` VALUES ('16', '管理员管理', '/Admin', '1', '0', '2', '1541656513', null);
INSERT INTO `power_node` VALUES ('17', '管理员管理', '/Operation/adminList', '2', '57', '1', '1541656544', null);
INSERT INTO `power_node` VALUES ('18', '管理员添加', '/Admin/adminAdd', '2', '57', '2', '1541656555', null);
...
INSERT INTO `power_node` VALUES ('27', '系统添加', '/System/systemAdd', '2', '26', '2', '1590550637', null);
...
INSERT INTO `power_node` VALUES ('30', '添加反馈', '/Feedback/feedbackAdd', '2', '29', '2', '1590558797', null);
INSERT INTO `power_node` VALUES ('31', '反馈列表', '/Feedback/feedbackList', '2', '29', '1', '1590558824', null);
INSERT INTO `power_node` VALUES ('32', '物业客服', '/Phone', '1', '0', '1', '1590561490', null);
INSERT INTO `power_node` VALUES ('33', '添加电话', '/Phone/phoneAdd', '2', '32', '2', '1590561517', null);
INSERT INTO `power_node` VALUES ('34', '电话列表', '/Phone/phoneList', '2', '32', '1', '1590561543', null);
INSERT INTO `power_node` VALUES ('35', '轮播图添加', '/Brand/banneradd', '2', '4', '2', '1590567544', null);
INSERT INTO `power_node` VALUES ('36', '轮播图', '/Brand/bannerList', '2', '4', '1', '1590571529', null);
INSERT INTO `power_node` VALUES ('37', '数据报表', '/Fontdata', '1', '0', '2', '1590633043', null);
INSERT INTO `power_node` VALUES ('38', '押金管理', '/Deposit', '1', '0', '1', '1590718197', null);
INSERT INTO `power_node` VALUES ('39', '创建押金订单', '/Deposit/depositAdd', '2', '38', '1', '1590718255', null);
INSERT INTO `power_node` VALUES ('40', '押金缴费', '/Deposit/depositList', '2', '38', '1', '1590718288', null);
INSERT INTO `power_node` VALUES ('41', '数据报表', '/Data', '1', '0', '1', '1590981501', null);
INSERT INTO `power_node` VALUES ('43', '数据报表', '/Data/dataList', '2', '41', '1', '1590981553', null);
INSERT INTO `power_node` VALUES ('44', '房屋管理', '/House', '1', '0', '2', '1591176296', null);
INSERT INTO `power_node` VALUES ('45', '房屋列表', '/House/index', '2', '44', '2', '1591176440', null);
INSERT INTO `power_node` VALUES ('46', '缴费创建', '/Order', '1', '0', '2', '1591951933', null);
INSERT INTO `power_node` VALUES ('47', '物业收费', '/Order/property', '2', '46', '2', '1591951956', null);
INSERT INTO `power_node` VALUES ('48', '供暖收费', '/Order/heating', '2', '46', '2', '1591951980', null);
INSERT INTO `power_node` VALUES ('49', '缴费记录', '/Pay_record/index', '2', '46', '2', '1591951997', null);
INSERT INTO `power_node` VALUES ('50', '小区列表', '/Home/district', '2', '51', '1', '1591952139', null);
INSERT INTO `power_node` VALUES ('51', '会员管理', '/Home', '1', '0', '1', null, null);
INSERT INTO `power_node` VALUES ('52', '会员列表', '/Home/homeList', '2', '51', '1', null, null);
INSERT INTO `power_node` VALUES ('53', '缴费创建', '/Orders', '1', '0', '1', null, null);
INSERT INTO `power_node` VALUES ('54', '物业收费单列表', '/Orders/propertyList', '2', '53', '1', null, null);
INSERT INTO `power_node` VALUES ('55', '供暖收费单列表', '/Orders/heatingList', '2', '53', '1', null, null);
INSERT INTO `power_node` VALUES ('56', '缴费订单列表', '/Orderno/paymentList', '2', '62', '1', null, null);
INSERT INTO `power_node` VALUES ('57', '权限管理', '/Operation', '1', '0', '1', null, null);
INSERT INTO `power_node` VALUES ('58', '操作日志记录', '/Operation/operationLog', '2', '57', '1', null, null);
INSERT INTO `power_node` VALUES ('59', '缴费订单添加', '/Orders/paymentAdd', '2', '53', '2', null, null);
INSERT INTO `power_node` VALUES ('60', '创建物业收费单', '/Orders/propertyAdd', '2', '53', '1', null, null);
INSERT INTO `power_node` VALUES ('61', '创建供暖收费单', '/Orders/heatingAdd', '2', '53', '1', null, null);
INSERT INTO `power_node` VALUES ('62', '缴费订单', '/Orderno', '1', '0', '1', null, null);
INSERT INTO `power_node` VALUES ('63', '押金退款', '/Deposit/refundList', '2', '38', '1', null, null);
INSERT INTO `power_node` VALUES ('64', '基本情况', '/Index', '1', '0', '1', null, null);
INSERT INTO `power_node` VALUES ('65', '基本情况详情', '/Index/Index', '2', '64', '1', null, null);
INSERT INTO `power_node` VALUES ('66', '微信小程序参数配置', '/System/WxApplets', '2', '26', '1', null, null);
INSERT INTO `power_node` VALUES ('69', 'pos机配置', '/System/Posconfig', '2', '26', '1', null, null);
INSERT INTO `power_node` VALUES ('70', '小程序服务图片', '/System/ImagesAdd', '2', '26', '1', null, null);
...
CREATE TABLE `role` (
  ...
  `type` char(1) DEFAULT NULL COMMENT '如果是超级管理员就没有，不是超级管理员1就是物业，2就是供暖，3是全部',
  `ctime` int(11) DEFAULT NULL,
  `utime` int(11) DEFAULT NULL,
  PRIMARY KEY (`role_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;
...
-- Records of role
-- ----------------------------
INSERT INTO `role` VALUES ('5', '超级管理员', '1', '1', null, '1595395279', null);
INSERT INTO `role` VALUES ('6', '超级管理员1', '1', '1', null, '1595395326', null);

-- ----------------------------
-- Table structure for role_district
-- ----------------------------
DROP TABLE IF EXISTS `role_district`;
CREATE TABLE `role_district` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `r_id` int(11) DEFAULT NULL COMMENT '角色id',
  `d_id` int(11) DEFAULT NULL COMMENT '小区ID',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COMMENT='角色小区关联表';

-- ----------------------------
-- Records of role_district
-- ----------------------------
INSERT INTO `role_district` VALUES ('10', '1', '1');
INSERT INTO `role_district` VALUES ('11', '1', '2');
INSERT INTO `role_district` VALUES ('13', '2', '1');
INSERT INTO `role_district` VALUES ('14', '2', '2');
INSERT INTO `role_district` VALUES ('15', '2', '3');
INSERT INTO `role_district` VALUES ('16', '3', '1');
INSERT INTO `role_district` VALUES ('17', '3', '2');
INSERT INTO `role_district` VALUES ('18', '3', '3');
INSERT INTO `role_district` VALUES ('19', '4', '4');
INSERT INTO `role_district` VALUES ('20', '4', '5');
INSERT INTO `role_district` VALUES ('21', '4', '6');
...
-- ----------------------------
INSERT INTO `role_node` VALUES ('76', '1', '53');
INSERT INTO `role_node` VALUES ('77', '1', '60');
INSERT INTO `role_node` VALUES ('78', '1', '54');
INSERT INTO `role_node` VALUES ('79', '1', '61');
INSERT INTO `role_node` VALUES ('80', '1', '55');
INSERT INTO `role_node` VALUES ('81', '1', '62');
INSERT INTO `role_node` VALUES ('82', '1', '56');
INSERT INTO `role_node` VALUES ('83', '1', '38');
INSERT INTO `role_node` VALUES ('84', '1', '39');
INSERT INTO `role_node` VALUES ('85', '1', '40');
INSERT INTO `role_node` VALUES ('86', '1', '63');
INSERT INTO `role_node` VALUES ('91', '2', '53');
INSERT INTO `role_node` VALUES ('92', '2', '60');
INSERT INTO `role_node` VALUES ('93', '2', '54');
INSERT INTO `role_node` VALUES ('94', '2', '61');
INSERT INTO `role_node` VALUES ('95', '2', '55');
INSERT INTO `role_node` VALUES ('96', '2', '62');
INSERT INTO `role_node` VALUES ('97', '2', '56');
INSERT INTO `role_node` VALUES ('98', '2', '38');
INSERT INTO `role_node` VALUES ('99', '2', '39');
INSERT INTO `role_node` VALUES ('100', '2', '40');
INSERT INTO `role_node` VALUES ('101', '2', '63');
INSERT INTO `role_node` VALUES ('102', '2', '41');
INSERT INTO `role_node` VALUES ('103', '2', '43');
INSERT INTO `role_node` VALUES ('106', '3', '53');
INSERT INTO `role_node` VALUES ('107', '3', '60');
INSERT INTO `role_node` VALUES ('108', '3', '54');
INSERT INTO `role_node` VALUES ('109', '3', '61');
INSERT INTO `role_node` VALUES ('110', '3', '55');
INSERT INTO `role_node` VALUES ('111', '3', '62');
INSERT INTO `role_node` VALUES ('112', '3', '56');
INSERT INTO `role_node` VALUES ('113', '3', '38');
INSERT INTO `role_node` VALUES ('114', '3', '39');
INSERT INTO `role_node` VALUES ('115', '3', '40');
INSERT INTO `role_node` VALUES ('116', '3', '63');
INSERT INTO `role_node` VALUES ('117', '3', '41');
INSERT INTO `role_node` VALUES ('118', '3', '43');
INSERT INTO `role_node` VALUES ('121', '4', '53');
INSERT INTO `role_node` VALUES ('122', '4', '60');
INSERT INTO `role_node` VALUES ('123', '4', '54');
INSERT INTO `role_node` VALUES ('124', '4', '61');
INSERT INTO `role_node` VALUES ('125', '4', '55');
INSERT INTO `role_node` VALUES ('126', '4', '62');
INSERT INTO `role_node` VALUES ('127', '4', '56');
INSERT INTO `role_node` VALUES ('128', '4', '38');
INSERT INTO `role_node` VALUES ('129', '4', '39');
INSERT INTO `role_node` VALUES ('130', '4', '40');
INSERT INTO `role_node` VALUES ('131', '4', '63');
INSERT INTO `role_node` VALUES ('132', '4', '41');
INSERT INTO `role_node` VALUES ('133', '4', '43');
...
-- Records of system
-- ----------------------------
INSERT INTO `system` VALUES ('1', '20200710/0e4b7004c86ad05bcb9dd39024246306.png', 'xxx物业管理系统', '©京Abc141111', '物业系统', '1', '1590650198');
...
CREATE TABLE `user` (
  ...
  `openId` varchar(100) DEFAULT NULL COMMENT '唯一标识',
  `tel` char(11) DEFAULT NULL COMMENT '手机号',
  `is_null` int(11) DEFAULT NULL COMMENT '1是绑定2是取消绑定',
  `default` int(11) DEFAULT NULL COMMENT '默认选中 房间',
  `status` int(11) DEFAULT NULL COMMENT '1正常2注销',
  `ctime` int(11) DEFAULT NULL,
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', '贾东杰', 'o4C2C4gCI1SODwE3i-ltdwn9FDUM', '15100330586', '1', '7', '1', '1595295017', null, 'JiaDongJie', '', 'Burgenland', 'Austria');
INSERT INTO `user` VALUES ('2', '张坤', 'o4C2C4t6unZm51TcEbH3go_MIWQc', '13313232323', '1', '11', '1', '1595382246', null, '垚yao', '', 'Moxico', 'Angola');
INSERT INTO `user` VALUES ('3', '东', 'o4C2C4puxlp3zl0ymHnjWH00nshk', '15100330555', '1', '12', '1', '1596437807', null, '小张小张有点嚣张', 'Zhangjiakou', 'Hebei', 'China');
INSERT INTO `user` VALUES ('4', '东', 'o3DTF5JrE8lVfvH1SsXpfFT0am_Y', '15100330555', '1', '14', '1', '1596523473', null, null, null, null, null);
...
CREATE TABLE `user_house` (
  ...
  `district_id` int(11) DEFAULT NULL COMMENT '小区ID',
  `district_name` varchar(50) DEFAULT NULL COMMENT '小区名称',
  `complex` varchar(50) DEFAULT NULL COMMENT '区',
  `home_code` varchar(50) DEFAULT NULL COMMENT '楼号',
  `owner` varchar(50) DEFAULT NULL COMMENT '业主姓名',
  `tel` char(11) DEFAULT NULL COMMENT '手机号',
  `status` int(11) DEFAULT NULL COMMENT '1正常2异常',
  `ctime` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8;
...
-- ----------------------------
INSERT INTO `user_house` VALUES ('1', '1', '1', '1', '芳源里', '甲', '1-1-101', '贾东杰', '15100330586', '1', '1595295017');
INSERT INTO `user_house` VALUES ('2', '2', '256', '1', '芳源里', '丙', '1-111-111', '张坤', '13313232323', '1', '1595382246');
INSERT INTO `user_house` VALUES ('3', '2', '6', '4', '金华园', '甲', '1-1-302', '贡勋', '13611196066', '1', '1595398217');
INSERT INTO `user_house` VALUES ('4', '2', '1', '4', '金华园', '甲', '1-1-101', '张玉珍', '13701144838', '1', '1595489526');
INSERT INTO `user_house` VALUES ('5', '2', '1677', '6', '金荣园', '二期', '底商-7', '朱井顺', '13522464333', '1', '1595560167');
INSERT INTO `user_house` VALUES ('6', '1', '2', '4', '金华园', '甲', '1-1-102', '李立平', '13552002220', '1', '1595563348');
INSERT INTO `user_house` VALUES ('7', '1', '1790', '1', '芳源里', '乙', '1-1-101', '东', '15100330555', '1', '1595901845');
INSERT INTO `user_house` VALUES ('8', '2', '1791', '2', '芳四期', '甲', '1-1-1', '多个手机号', '18616659655', '1', '1596088765');
INSERT INTO `user_house` VALUES ('9', '2', '1790', '1', '芳源里', '乙', '1-1-101', '东', '15100330555', '1', '1596159548');
INSERT INTO `user_house` VALUES ('11', '2', '1799', '9', '苹果园', '甲', '1-1-301', '张五', '13901185398', '1', '1596178158');
INSERT INTO `user_house` VALUES ('12', '3', '1790', '1', '芳源里', '乙', '1-1-101', '东', '15100330555', '1', '1596437807');
INSERT INTO `user_house` VALUES ('13', '3', '1799', '9', '苹果园', '甲', '1-1-301', '张五', '13901185398', '1', '1596438835');
INSERT INTO `user_house` VALUES ('14', '4', '1790', '1', '芳源里', '乙', '1-1-101', '东', '15100330555', '1', '1596523473');
