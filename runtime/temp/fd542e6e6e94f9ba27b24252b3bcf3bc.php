...
<!--            <div class="layui-input-block">-->
<!--                <input type="text" name="name" value="<?php echo $store['name']; ?>" readonly="readonly" autocomplete="off" placeholder="请输入门店名称" class="layui-input">-->
<!--            </div>-->
        </div>
    </div>
