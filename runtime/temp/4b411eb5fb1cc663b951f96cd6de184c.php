...
<div class='layui-p-b'>
    ...
    <span class="layui-breadcrumb">
        <a href='#'>门店管理</a>
        <a><cite> 查看门店信息</cite></a>
    </span>
</blockquote>
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
    <legend>门店基础信息</legend>
</fieldset>
...
<!--            <div class="layui-form-mid layui-word-aux"><?php echo $store['name']; ?></div>-->
            <div class="layui-input-block">
                <input type="text" name="name" value="<?php echo $store['name']; ?>" disabled="disabled" autocomplete="off" placeholder="请输入门店名称" class="layui-input">
            </div>
        </div>
    </div>
...
<!--        <div class="layui-form-mid layui-word-aux"><?php echo $store['address']; ?></div>-->
        <div class="layui-input-block">
            <input type="text" name="address" value="<?php echo $store['address']; ?>" disabled="disabled" autocomplete="off" placeholder="请输入门店地址" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" disabled="disabled" value="<?php echo $store['start_business_hours']; ?>" id="test4" name="start_business_hours" placeholder="开始时间">
            </div>
            <div class="layui-form-mid">-</div>
            <div class="layui-input-inline">
                <input type="text" class="layui-input" disabled="disabled" value="<?php echo $store['end_business_hours']; ?>" id="test5" name="end_business_hours" placeholder="结束时间">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-block">
                <input type="text" name="user_name" value="<?php echo $store['user_name']; ?>" disabled="disabled" autocomplete="off" placeholder="请输入联系人" class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label">联系方式:</label>
            <div class="layui-input-block">
                <input type="text" name="user_tel" value="<?php echo $store['user_tel']; ?>" disabled="disabled" autocomplete="off" placeholder="请输入联系方式" class="layui-input">
            </div>
        </div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-block">
                <input type="text" name="account" value="<?php echo $store['account']; ?>" disabled="disabled" autocomplete="off" placeholder="请输入登录账号" class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label">登录密码:</label>
            <div class="layui-input-block">
                <input type="text" name="passwords" value="<?php echo $store['password']; ?>" disabled="disabled" autocomplete="off" placeholder="请输入登录密码" class="layui-input">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-block">
                <input type="text" name="pos_pay" value="<?php echo $store['pos_pay']; ?>" disabled="disabled" autocomplete="off" placeholder="" class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label">刷脸支付:</label>
            <div class="layui-input-block">
                <input type="text" name="face_pay" value="<?php echo $store['face_pay']; ?>" disabled="disabled" autocomplete="off" placeholder="" class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label">小票机:</label>
            <div class="layui-input-block">
                <input type="text" name="password" value="<?php echo $store['password']; ?>" disabled="disabled" autocomplete="off" placeholder="" class="layui-input">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
