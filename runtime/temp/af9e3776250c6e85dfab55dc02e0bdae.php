<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"D:\phpstudy_pro\WWW\member\public/../application/admin\view\orders\propertyadd.html";i:1596433451;s:71:"D:\phpstudy_pro\WWW\member\public/../application/admin\view\layout.html";i:1596511401;s:76:"D:\phpstudy_pro\WWW\member\public/../application/admin\view\public\head.html";i:1597028307;s:76:"D:\phpstudy_pro\WWW\member\public/../application/admin\view\public\left.html";i:1597028892;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class='layui-p-b'>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label">物业：<span style="color: red;">*</span></label>
            ...
            <div class="layui-input-inline" style="width: 68px;">
                <input type="text" name=""  style="border:0;outline:0;" value="房屋面积" disabled="disabled" autocomplete="off" class="layui-input">
            </div>
            <div class="layui-form-mid">X</div>
            <div class="layui-input-inline" style="width: 25px;">
                <input type="text" name="month" value="12"  style="border:0;outline:0;" disabled="disabled" autocomplete="off" class="layui-input">
            </div>
            <div class="layui-form-mid">个月</div>
            <div class="layui-form-mid">+</div>
            <div class="layui-input-inline" style="width: 100px;">
                <input type="text" name="cost" value="" autocomplete="off" placeholder="请输入费用" class="layui-input">
            </div>
            <div class="layui-form-mid">其他费用</div>
        </div>
    </div>
    ...
    $(function(){
        layui.use(['form','layer','upload','laydate'], function(){
            ...
            form.on('submit(*)',function(data){
                ...
                info.dname=userName;
                $.post(
                        "<?php echo url('Orders/propertyAdd'); ?>",
                        info,
                        function(msg){
