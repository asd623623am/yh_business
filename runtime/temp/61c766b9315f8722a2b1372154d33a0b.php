<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"D:\phpstudy_pro\WWW\member\public/../application/admin\view\orders\heatinglist.html";i:1596433447;s:71:"D:\phpstudy_pro\WWW\member\public/../application/admin\view\layout.html";i:1596511401;s:76:"D:\phpstudy_pro\WWW\member\public/../application/admin\view\public\head.html";i:1593748844;s:76:"D:\phpstudy_pro\WWW\member\public/../application/admin\view\public\left.html";i:1594002199;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    layui.use(['table','layer','upload','form'], function(){
        ...
        table.render({
            elem: '#test'
            ,url:'<?php echo url("Orders/heatingList"); ?>'
            ,limit: 10
            ,where:{status:2}
         ...
         $('#submit').click(function(){
            location.href="<?php echo url('Orders/heatingAdd'); ?>";
        })
        ...
        table.on('tool(test)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
            ...
            if(layEvent === 'detail'){ //查看
                location.href="<?php echo url('Orders/heatingUpdateInfo'); ?>?id="+data.p_id;
            } else if(layEvent === 'del'){ //删除
                layer.confirm('真的删除行么', function(index){
                    $.post(
                            '<?php echo url("Orders/heatingDel"); ?>',
        ...
        form.on('submit(*)', function(data){
          table.render({
              elem: '#test'
              ,url:"<?php echo url('Orders/heatingNewList'); ?>"
              ,where:data.field
              ,limit:10
              ,cellMinWidth: 80 //全局定义常规单元格的最小宽度，layui 2.2.1 新增
              ,cols: [[
