    ...
    $(function(){
        layui.use(['form','layer','upload'], function(){
            ...
            var layer = layui.layer;
            	$('#up').click(function(){
            	    location.href="<?php echo url('Data/dataList'); ?>";
            	});
            //监听提交
            form.on('submit(*)',function(data){
            	var newtemp = data.field;
            	location.href="<?php echo url('Data/exportExcel'); ?>?fileName="+newtemp.fileName+"&tableName="+newtemp.tableName+"&excel_show="+newtemp.excel_show+"&xiaoqu="+newtemp.dis+"&qu="+newtemp.qu;
            	return false;
                $.post(
                        "<?php echo url('Data/exceAdd'); ?>",
                        data.field,
                        function(msg){
