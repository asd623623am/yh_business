    ...
    layui.use(['table','layer'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'admin_name', width:100, title: '用户名'}
                ,{field:'admin_email', width:300, title: '邮箱'}
                ,{field:'admin_tel', width:270, title: '电话'}
        ...
        table.on('tool(testdd)', function(obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
            ...
            if (layEvent === 'edit') { //查看
                ...
                location.href="<?php echo url('Admin/adminUpdateInfo'); ?>?admin_id="+data.admin_id+"&page="+pages;
