<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:85:"D:\phpstudy_pro\WWW\member\public/../application/admin\view\business\businessadd.html";i:1597129792;s:71:"D:\phpstudy_pro\WWW\member\public/../application/admin\view\layout.html";i:1596511401;s:76:"D:\phpstudy_pro\WWW\member\public/../application/admin\view\public\head.html";i:1597028307;s:76:"D:\phpstudy_pro\WWW\member\public/../application/admin\view\public\left.html";i:1597028892;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class='layui-p-b'>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="bname"  autocomplete="off" placeholder="商户名称" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    $(function(){
        layui.use(['form','layer','upload','laydate'], function(){
            ...
            form.on('submit(*)',function(data){
                var info = data.field;
                $.post(
                    "<?php echo url('Business/businessAdd'); ?>",
                    info,
                    function(msg){
                        console.log(msg);
                    },'json'
