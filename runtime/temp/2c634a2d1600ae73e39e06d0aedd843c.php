<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:81:"D:\phpstudy_pro\WWW\member\public/../application/admin\view\system\posconfig.html";i:1596433545;s:71:"D:\phpstudy_pro\WWW\member\public/../application/admin\view\layout.html";i:1596511401;s:76:"D:\phpstudy_pro\WWW\member\public/../application/admin\view\public\head.html";i:1597028307;s:76:"D:\phpstudy_pro\WWW\member\public/../application/admin\view\public\left.html";i:1597028892;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    layui.use(['table','layer'], function(){
        ...
        table.render({
            elem: '#test'
            ,url:'<?php echo url("System/Posconfig"); ?>'
            ,limit: 10
         ...
         $('#submit').click(function(){
            location.href="<?php echo url('System/posAdd'); ?>";
            return false;
        })
        //删除和修改
        table.on('tool(test)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
            ...
            if(layEvent === 'detail'){ //查看
                location.href="<?php echo url('System/posUpdateInfo'); ?>?id="+data.id;
            } else if(layEvent === 'del'){ //删除
                layer.confirm('真的删除行么', function(index){
                    $.post(
                            '<?php echo url("System/posDel"); ?>',
                            {id:data.id},
                            function(msg){
