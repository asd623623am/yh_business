...
<div class='layui-p-b'>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <input type="hidden" value="<?php echo $data['company_logo']; ?>" id="logo" name="company_logo">
