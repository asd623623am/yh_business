...
<script type="text/javascript">
    ...
    <div class="layui-input-block">
      <input type="radio" name="sex" value="甲" title="甲" checked="">
      <input type="radio" name="sex" value="乙" title="乙">
      <input type="radio" name="sex" value="丙" title="丙">
      <input type="radio" name="sex" value="丁" title="丁">
      <input type="radio" name="sex" value="四期" title="四期">
      <input type="radio" name="sex" value="四期商业" title="四期商业">
    </div>
  </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
               <input type="text" name="paytime"  autocomplete="off" placeholder="输入收费年" class="layui-input">
           </div>
    </div>  
    ...
    <div class="layui-input-block">
      <input type="radio" name="type" value="0" title="物业" checked="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="fee"  autocomplete="off" placeholder="请输入费用" class="layui-input">
        </div>
    </div>
    ...
    $(function(){
        layui.use(['form','layer','upload','laydate'], function(){
            ...
            form.on('submit(*)',function(data){
                ...
                info.dname=userName;
                $.post(
                        "<?php echo url('Orders/paymentAdd'); ?>",
                        info,
                        function(msg){
