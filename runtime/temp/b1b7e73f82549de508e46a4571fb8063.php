...
<form class="layui-form">
    <div class="layui-form-item" style="display: none">
        <div class="layui-inline" >
            ...
            <div class="layui-input-block">
                <input type="text" name="gtid" value="<?php echo $gt['gtid']; ?>"  autocomplete="off" placeholder="请输入门店名称" class="layui-input">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-block">
                <input type="text" name="gtname" value="<?php echo $gt['gtname']; ?>"  autocomplete="off" placeholder="请输入门店名称" class="layui-input">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-block">
                <input type="text" name="sort"  value="<?php echo $gt['sort']; ?>" autocomplete="off" placeholder="" class="layui-input">
            </div>
        </div>
    </div>
    ...
    $(function(){
        layui.use(['form','layer',], function(){
            ...
            form.on('submit(*)',function(data){
                var info = data.field;
                $.post(
                    "<?php echo url('Goods/goodsTypeEdit'); ?>",
                    info,
                    function(msg){
                        if(msg.code ==1){
                            layer.msg(msg.font);
