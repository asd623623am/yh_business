...
<form class="layui-form">
    ...
    <div class="layui-form-item" hidden>
        <label class="layui-form-label">超级管理员<span style="color: red;">*</span></label>
    ...
    <!-- <div class="layui-form-item">
       <label class="layui-form-label">选择小区<span style="color: red;">*</span></label>
       <div class="layui-input-block">
         ...
         <input type="checkbox" name="like[]" value="<?php echo $val['id']; ?>" title="<?php echo $val['name']; ?>">
         <?php endforeach; endif; else: echo "" ;endif; ?>
       </div>
     </div>
     <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input type="radio" name="type" value="3" title="全部" checked>
        </div>
    </div> -->
    <!-- <div class="layui-form-item">
