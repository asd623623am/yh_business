...
<div class='layui-p-b'>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="home_code" value="<?php echo $data['home_code']; ?>"  autocomplete="off" placeholder="请输入楼/单元/户号" class="layui-input">
        </div>
    </div>
