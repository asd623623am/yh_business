...
<script type="text/javascript">
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <textarea placeholder="请输入备注" name="content" class="layui-textarea" lay-verify="required"></textarea>
        </div>
    </div>
